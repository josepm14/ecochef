...
<body class="bg-gray-100">
    <header class="bg-green-600 text-white p-4 flex justify-between items-center">
        <h1 class="text-xl font-bold">EcoChef - Dashboard de Beneficiario</h1>
        <nav>
    ...
    <main class="container mx-auto mt-8 p-4">
        <h2 class="text-2xl font-bold mb-4">Bienvenido, Beneficiario!</h2>
        <p>Aquí puedes ver tus productos comprados, recetas y talleres.</p>
        <!-- Contenido específico del dashboard de beneficiario -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-lg font-semibold mb-2">Mis Productos</h3>
                <p>Revisa los productos que has adquirido.</p>
                <a href="#" class="text-green-600 hover:underline">Ver Productos</a>
            </div>
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-lg font-semibold mb-2">Mis Recetas</h3>
                <p>Explora las recetas que te interesan.</p>
