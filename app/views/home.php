<?php
// =======================================
// EcoChef - Página de inicio
// Ruta: app/views/home.php
// =======================================
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="bg-gray-50 font-sans">
  ...
  <section class="bg-gradient-to-r from-green-600 to-lime-500 text-white">
    <div class="container mx-auto px-6 py-20 text-center">
      ...
      <a href="#roles" class="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-100 transition">
        Acceder
      </a>
    </div>
  </section>
  ...
  <section id="roles" class="bg-gray-100 py-16">
    <div class="container mx-auto px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
        ...
        <a href="/usuario" class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
        ...
        <a href="/chef" class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
        ...
        <a href="/productor" class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
        ...
        <a href="/admin" class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
